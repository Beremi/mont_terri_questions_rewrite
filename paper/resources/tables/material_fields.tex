...
Run-local \texttt{MeshElement} field \texttt{k\_i\_rd}.  Current release gates allow
...
Run-local \texttt{MeshElement} field \texttt{n\_rd}, fixed at \(0.105\) in the
...
Measured aperture could imply hydraulic aperture or local permeability only after
