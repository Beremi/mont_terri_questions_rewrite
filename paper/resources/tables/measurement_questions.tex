...
\((\uu(\xx_a)-\uu(\xx_b))\cdot\mathbf n\), projected near-crack strain, or a
special displacement-jump/crack-aperture variable.  The current continuum model does
not provide a crack-aperture state by default.}
\mqPair{mqGate}{Gate}
