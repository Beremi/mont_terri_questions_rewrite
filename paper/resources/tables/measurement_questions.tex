...
local/public evidence boundary and the missing provider or modelling decision.  The
inverse-problem check rows make the observation operator, covariance, nuisance terms,
and identifiability risks explicit.}
...
{The tables used here come from the processed-observation layer in
...
{For the local \texttt{Kluft} zones, yes for current model use: the source extraction records
