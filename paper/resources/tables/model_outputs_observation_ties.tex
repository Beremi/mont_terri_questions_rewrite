...
\endlastfoot
\(\pl\) &
Primary variable and run-local VTU output. &
Direct pressure or mini-piezometer data, pressure-boundary audit, and pressure
diagnostics. &
...
\(\Sl\) &
Secondary variable and run-local VTU output. &
...
\(\por\) &
Material field and run-local VTU output. &
...
Mechanical plausibility, crack/deformation interpretation, and prestress audit. &
