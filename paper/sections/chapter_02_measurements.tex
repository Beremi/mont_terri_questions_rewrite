...
script, RH workbook check, and the CD-A water-content/RH formulation where negative
...
{Primarily an input-side boundary source or check for \(p_E(t)\), not an interior
OGS output residual.}
\gqPair{gqReady}{Ready}
...
source scan found layout geometry, laser surface geometry, levelling slide rows, and
...
metadata needed for weighting \citep[PDF pp.~5--6]{Levelling2026Email}.
