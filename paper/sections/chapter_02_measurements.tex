...
{Not proven by the available source files; the provider must state the correction, gas pressure range,
...
{Through \(\theta=\por\Sl\) and the current empirical resistivity transform, followed
...
{Unknown from the available source files; treat it as a source-unit dielectric/water-content proxy until
...
{RH5/RH6 are the cleanest source candidates, but final use needs explicit sensor
